/*
* This is a test table for the registration module --EM
*/
drop table registration;
create table registration(username char(20), pass char(20), first char(20), last char(20), address varchar(30), phone int(10));
